...
ClapTrap::ClapTrap(void) : name("Default"), energyPoints(10), healthPoints(10), damagePoints(0) {
    std::cout << "Object ClapTrap " << this->name << " created" << std::endl;
}

ClapTrap::ClapTrap(const std::string name) : name(name), energyPoints(10), healthPoints(10), damagePoints(0){
    std::cout << "Object ClapTrap " << this->name << " created" << std::endl;
}
